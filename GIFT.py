...
#------------------- [user_agent] ---------------#
def ugen():
        and_ver = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
        ver_code = str(random.randint(000000000,999999999))
        fbpn = random.choice(["com.facebook.katana"])   
        sam = "[FBAN/FB4A;FBAV/"+and_ver+";FBBV/"+ver_code+";FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBRV/"+ver_code+";FBCR/airtel;FBMF/samsung;FBBD/samsung;FBPN/"+str(fbpn)+";FBDV/12;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]"
        return sam
#----------------[method_crack]-------------------#
...
if __name__ == '__main__':
	os.system('clear');os.system('git pull');time.sleep(2)
MAIN()